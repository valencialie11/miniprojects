...
def firstsegment():
    ...
    while True:
        try:
            ...
            if firstchoice == 1:
                print("Suddenly, Mr Avery came. He handed each person a paper and asked everyone to write 500 essay on the negative impacts of technology on teens in America. What would you do next?")
                ...
                while True:
                    try:
                        action = int(input())
                        if action == 1:
                            print('"My name is " + name + ". Nice to meet you guys, I guess. Ive been here since freshman though..." you said silently.')
                            print("Suddenly, Mr Avery came. He handed each person a paper and asked everyone to write 500 essay on the negative impacts of technology on teens in America. What would you do next?")
                        elif action == 2:
